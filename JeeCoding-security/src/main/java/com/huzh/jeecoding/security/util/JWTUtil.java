package com.huzh.jeecoding.security.util;
...
public class JWTUtil {
     ...
     * @param loginUserName  从数据库中查询出来的用户信息
     */
    public boolean validateToken(String token, String loginUserName) {
        String username = getUserNameFromToken(token);
        return username.equals(loginUserName) && !isTokenExpired(token);
    }
    ...
    public String generateToken(String loginUserName) {
        ...
        claims.put(CLAIM_KEY_USERNAME, loginUserName);
